...
local function lsp_on_attach(ev)
	...
	map("<leader>gd", function() require("fzf-lua").lsp_definitions({ jump_to_single_result = true }) end, "Go to definition (fzf)")
	map("<leader>gD", vim.lsp.buf.definition, "Go to definition")
	map("<leader>gS", function() vim.cmd("vsplit"); vim.lsp.buf.definition() end, "Go to definition (split)")
	...
	map("<leader>fd", function() require("fzf-lua").lsp_definitions({ jump_to_single_result = true }) end, "LSP definitions")
